...
public class BoardViewPageControllerTest extends ShelterApplicationTests {
    ...
    public BoardViewPageControllerTest(MockMvc mockMvc, BoardLogicService boardLogicService, AnswerLogicService answerLogicService, AccountRepository accountRepository, AccountService accountService) {
