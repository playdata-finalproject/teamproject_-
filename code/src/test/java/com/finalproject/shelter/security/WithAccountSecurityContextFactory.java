package com.finalproject.shelter.security;
...
public class WithAccountSecurityContextFactory implements WithSecurityContextFactory<WithAccount> { //Bean으로 등록된다.
    ...
    public SecurityContext createSecurityContext(WithAccount withAccount) {
        ...
        signUpForm.setEmail(signUpForm.getIdentity() + "@gmail.com");
        signUpForm.setPassword("12345678");
        accountService.processNewAccount(signUpForm);

        UserDetails principal = accountService.loadUserByUsername(signUpForm.getIdentity());
